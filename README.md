...
- **Phân Loại Rác**: Hệ thống phân loại được phát triển dựa trên việc fine-tune model `prithivMLmods/Augmented-Waste-Classifier-SigLIP2` để phân loại rác thành các loại chính: nhựa, giấy, thủy tinh, kim loại.
