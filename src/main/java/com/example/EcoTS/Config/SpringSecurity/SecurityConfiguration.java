...
public class SecurityConfiguration {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/**", "/user/**", "/admin/**", "/location/**", "/detect/**", "/detect-response/**", "/rank/**",
                                ...
                                "/reward/**", "/sponsor/**", "/newsfeed/**", "/poll/**", "/newsfeed-statistic/**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://ecots-be.onrender.com", "http://localhost:3000", "http://localhost:7050", "http://localhost:5173", "https://sponsorwebecotise-production.up.railway.app")); // Specify your server's origin
